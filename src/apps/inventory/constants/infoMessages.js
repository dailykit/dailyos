export const BULK_WORK_ORDER_INFO_TUNNEL =
   'Bulk Work Order is to create bulk items with changing processing'

export const SACHET_WORK_ORDER_INFO_TUNNEL =
   'Sachet Work Order is to create planned lot items by portioning and packaging'
