...
mutation MyMutation($id : Int!, $heading : String!, $subHeading : String!) {
   update_content_informationGrid(where: {id: {_eq: $id}},_set: {heading:$heading,subHeading:$subHeading}) {
      returning {
         heading
         subHeading
      }
...
mutation MyMutation($id : Int!, $heading : String!, $subHeading : String!) {
   update_content_faqs(where: {id: {_eq: $id}},_set: {heading:$heading,subHeading:$subHeading}) {
     returning {
       heading
       subHeading
     }
