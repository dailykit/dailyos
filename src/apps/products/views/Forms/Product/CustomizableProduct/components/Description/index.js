            ...
            {state.additionalText || state.description || state.tags?.length ? (
               <StyledContainer>
                  ...
                  <Flex container alignItems="center">
                     ...
                     <Tooltip identifier="customizable_product_additional_text" />
                  </Flex>
                  <Text as="p">{state.additionalText || 'NA'}</Text>
                  <Spacer size="16px" />
                  <Flex container alignItems="center">
                     <Text as="subtitle">Tags</Text>
                     <Tooltip identifier="customizable_product_tags" />
                  </Flex>
                  <Spacer size="4px" />
                  {state.tags?.length ? (
                     <TagGroup>
                  ...
                  <Flex container alignItems="center">
                     ...
                     <Tooltip identifier="customizable_product_description" />
                  </Flex>
