               ...
               <Container bottom="16">
                  <span
                     onClick={() =>
                        addTab(
                           'Recurrences',
                           `/menu/settings/recurrences/PREORDER_DELIVERY`
                        )
                     }
               ...
               <Container bottom="16">
                  <span
                     onClick={() =>
                        addTab(
                           'Recurrences',
                           `/menu/settings/recurrences/PREORDER_PICKUP`
                        )
                     }
                     style={{ cursor: 'pointer' }}
                  >
               ...
               <Container bottom="16">
                  <span
                     onClick={() =>
                        addTab(
                           'Recurrences',
                           `/menu/settings/recurrences/ONDEMAND_DELIVERY`
                        )
                     }
                     style={{ cursor: 'pointer' }}
                  >
               ...
               <Container bottom="16">
                  <span
                     onClick={() =>
                        addTab(
                           'Recurrences',
                           `/menu/settings/recurrences/ONDEMAND_PICKUP`
                        )
                     }
                     style={{ cursor: 'pointer' }}
                  >
